...
function Services() {
  return (
    <>
      <SectionIntro
        eyebrow="Services"
        title="Our Expertise: Crafting Exceptional Digital Experiences."
        className="mt-24 sm:mt-32 lg:mt-40"
      >
        <p>
      ...
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
            <ListItem title="Ecommerce Solutions">
            Unlock the full potential of your business with our ecommerce solutions. We design user-friendly, robust online stores that enhance the shopping experience and drive sales growth.
            </ListItem>
            <ListItem title="Custom Landing Pages">
    ...
    <>
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          Modern Designs, Affordable Prices, and Unmatched Quality
          </p>
        </FadeIn>
      </Container>
